...
$save1 = 'SELECT DISTINCT * WHERE {
    ?game rdf:type games:RPG-adventure;
    games:abstract ?desc;
...
$featured = [
  [
    'bg'    => 'https://media.tenor.com/M2oGsrAT9tAAAAAC/harry-potter-hogwarts-legacy.gif',
    'cover'    => 'https://upload.wikimedia.org/wikipedia/en/7/7c/Hogwarts-Legacy-cover.jpg',
    'uri'    => 'https://dbpedia.org/page/Hogwarts_Legacy',
    'nama'    => 'Hogwarts Legacy',
    'dev'    => 'Avalanche Software',
    'year'    => '2023',
    'desc'    => 'Hogwarts Legacy is a 2023 action role-playing game set in the Wizarding World during the 1800s, developed by Avalanche Software. Players attend Hogwarts School of Witchcraft and Wizardry while uncovering a hidden truth threatening the wizarding world.',
  ],
  [
    'bg'    => 'https://i.pinimg.com/originals/77/94/ca/7794cac2f48b09c570e7d632726d477f.gif',
    'cover'    => 'https://upload.wikimedia.org/wikipedia/en/2/2b/ArkSurvivalEvolved.png',
    'uri'    => 'https://dbpedia.org/page/Ark:_Survival_Evolved',
    'nama'    => 'Ark: Survival Evolved',
    'dev'    => 'Studio Wildcard',
    'year'    => '2017',
    'desc'    => 'Ark: Survival Evolved is a 2017 RPG-adventure survival game developed by Studio Wildcard. Stranded on a mysterious island roamed by dinosaurs, players must craft, build, and tame creatures to survive against nature and rival tribes.',
  ],
  [
    'bg'    => 'https://media.tenor.com/j38EKFO4ULQAAAAC/lords-of-the-fallen-soulslike.gif',
    'cover'    => 'https://upload.wikimedia.org/wikipedia/en/6/64/Lords_of_The_Fallen.png',
    'uri'    => 'https://dbpedia.org/page/Lords_of_the_Fallen',
    'nama'    => 'Lords of the Fallen',
    'dev'    => 'Deck13, CI Games',
    'year'    => '2014',
    'desc'    => 'Lords of the Fallen is a 2014 action role-playing game developed by Deck13 and CI Games. Convicted criminal Harkyn is granted a second chance to redeem himself by standing against an invading army of otherworldly beings.',
  ],
];
?>
<!DOCTYPE html>
...
<head>
  ...
  <title>RPG-Adventure — Smart Game Seeker</title>
...
<body>
  ...
  <section class="feat">
    <div class="feat__head">
      <div>
        <h1 class="feat__title">RPG <span class="lime">ADVENTURE</span></h1>
        <p class="feat__sub">アドベンチャーRPG</p>
      </div>
    </div>
  ...
  <section class="list">
    ...
    <?php if (count($result) === 0) : ?>
      <div class="empty">
        ...
        <h4>Belum ada data RPG-Adventure</h4>
        <p>
          Dataset <code>RPG</code> pada Fuseki belum berisi triple bertipe
          <code>games:RPG-adventure</code>, atau server di
  ...
  <!-- ===================== FOOTER ===================== -->
  <footer class="foot">
    <span class="jp">アドベンチャーRPG &middot; SEEKER</span>
        ...
        <div class="modal-body">
          <div class="row">
            ...
            <div class="col-12 col-sm-6 col-md-4 genre-col">
              ...
              <a href="./rpg_adventure.php" class="is-current">RPG-Adventure</a>
