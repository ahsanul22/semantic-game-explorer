...
$sparql_jena_Simulation = new \EasyRdf\Sparql\Client('http://localhost:3030/Simulation/sparql');

// ------------------------------------------------------------------
// Query ke dataset "Simulation" di Fuseki (logika asli, tidak diubah)
// ------------------------------------------------------------------
$save1 = 'SELECT DISTINCT * WHERE {
    ?game rdf:type games:simulation-car;
    games:abstract ?desc;
...
$result = $sparql_jena_Simulation->query($save1);

// Slide unggulan pada carousel
$featured = [
  [
    'bg'    => 'https://i.pinimg.com/originals/17/cc/34/17cc347e922f195d246126a8c3365886.gif',
    'cover'    => 'https://upload.wikimedia.org/wikipedia/en/e/e3/Driver_San_Francisco_Box_Art.jpg',
    'uri'    => 'https://dbpedia.org/page/Driver:_San_Francisco',
    'nama'    => 'Driver: San Francisco',
    'dev'    => 'Ubisoft Reflections',
    'year'    => '2011',
    'desc'    => 'Driver: San Francisco is a 2011 open-world racing game developed by Ubisoft Reflections. Detective Tanner chases a rival across a fictionalised San Francisco, using a "shift" ability to instantly swap into the body of any driver on the road.',
  ],
  [
    'bg'    => 'https://steamuserimages-a.akamaihd.net/ugc/445078188309796483/74539CAF543F5B6453AC10EC3104C507F18F38F1/',
    'cover'    => 'https://steamuserimages-a.akamaihd.net/ugc/445078188309796483/74539CAF543F5B6453AC10EC3104C507F18F38F1/',
    'uri'    => 'https://dbpedia.org/page/Shift_2:_Unleashed',
    'nama'    => 'Shift 2: Unleashed',
    'dev'    => 'Slightly Mad Studios',
    'year'    => '2011',
    'desc'    => 'Shift 2: Unleashed is a 2011 racing simulation developed by Slightly Mad Studios and published by Electronic Arts. The sequel to Need for Speed: Shift emphasises cockpit-view immersion and a helmet-cam that reacts to crashes and high-speed cornering.',
  ],
  [
    'bg'    => 'https://steamuserimages-a.akamaihd.net/ugc/1011562931204556898/DFC7C86D1122873DB3ECD92943F83B4B18F4CDE1/',
    'cover'    => 'https://i.ytimg.com/vi/Hv_s-VcSqRA/maxresdefault.jpg',
    'uri'    => 'https://dbpedia.org/page/Automobilista_2',
    'nama'    => 'Automobilista 2',
    'dev'    => 'Reiza Studios',
    'year'    => '2020',
    'desc'    => 'Automobilista 2 is a racing simulation developed and published by Reiza Studios, built on the Madness engine. It delivers a highly realistic driving experience across open-wheel, touring car, and endurance racing disciplines on real-world tracks.',
  ],
];
?>
<!DOCTYPE html>
...
<head>
  ...
  <title>Simulation-Car — Smart Game Seeker</title>
...
<body>
  ...
  <section class="feat">
    <div class="feat__head">
      <div>
        <h1 class="feat__title">CAR <span class="lime">SIMULATION</span></h1>
        <p class="feat__sub">カーシミュレーション</p>
      </div>
    </div>
  ...
  <section class="list">
    ...
    <?php if (count($result) === 0) : ?>
      <div class="empty">
        ...
        <h4>Belum ada data Simulation-Car</h4>
        <p>
          Dataset <code>Simulation</code> pada Fuseki belum berisi triple bertipe
          <code>games:simulation-car</code>, atau server di
  ...
  <!-- ===================== FOOTER ===================== -->
  <footer class="foot">
    <span class="jp">カーシミュレーション &middot; SEEKER</span>
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <div class="row">
            ...
            <div class="col-12 col-sm-6 col-md-4 genre-col">
              <h2>Simulation</h2>
              <a href="./simulation_car.php" class="is-current">Simulation-Car</a>
