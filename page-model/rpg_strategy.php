...
$sparql_jena_RPG = new \EasyRdf\Sparql\Client('http://localhost:3030/RPG/sparql');

// ------------------------------------------------------------------
// Query ke dataset "RPG" di Fuseki (logika asli, tidak diubah)
// ------------------------------------------------------------------
$save1 = 'SELECT DISTINCT * WHERE {
    ?game rdf:type games:RPG-strategy;
    games:abstract ?desc;
...
$result = $sparql_jena_RPG->query($save1);

// Slide unggulan pada carousel
$featured = [
  [
    'bg'    => 'https://i.pinimg.com/originals/f2/5e/8c/f25e8c826aa44385b32dab28ff7798b8.gif',
    'cover'    => 'https://upload.wikimedia.org/wikipedia/en/0/04/Fftpsp3.jpg',
    'uri'    => 'https://dbpedia.org/page/Final_Fantasy_Tactics:_The_War_of_the_Lions',
    'nama'    => 'Final Fantasy Tactics: The War of the Lions',
    'dev'    => 'Square Enix',
    'year'    => '2007',
    'desc'    => 'Final Fantasy Tactics: The War of the Lions is a tactical role-playing game developed by Square Enix for the PSP. Mercenary Ramza Beoulve is drawn into a civil war shaped by political conspiracy, class conflict, and battles fought on grid-based maps.',
  ],
  [
    'bg'    => 'https://fig-images.imgix.net/https%3A%2F%2Fplayfig.s3.amazonaws.com%2FCampaignMediaItem%2Fimage%2Fcampaign_media_item%2F2019%2F08%2F02%2Ff46b7631-33b1-4d55-afbc-8c29ee765c0a',
    'cover'    => 'https://upload.wikimedia.org/wikipedia/en/4/45/Wasteland_3_cover_art.jpg',
    'uri'    => 'https://dbpedia.org/page/Wasteland_3',
    'nama'    => 'Wasteland 3',
    'dev'    => 'inXile Entertainment',
    'year'    => '2020',
    'desc'    => 'Wasteland 3 is a 2020 tactical role-playing game developed by inXile Entertainment, sequel to Wasteland 2. A squad of Desert Rangers is sent to frozen, war-torn Colorado to secure an alliance and confront a family of ruthless rulers.',
  ],
  [
    'bg'    => 'https://i.makeagif.com/media/7-02-2016/wQ-eaY.gif',
    'cover'    => 'https://upload.wikimedia.org/wikipedia/en/0/0a/Disgaea_5_-_Alliance_of_Vengeance.png',
    'uri'    => 'https://dbpedia.org/page/Disgaea_5',
    'nama'    => 'Disgaea 5: Alliance of Vengeance',
    'dev'    => 'Nippon Ichi Software',
    'year'    => '2015',
    'desc'    => 'Disgaea 5: Alliance of Vengeance is a 2015 tactical role-playing game by Nippon Ichi Software. Rebel demon Killia leads an alliance of overlords against the tyrannical Void Dark, battling across absurdly deep grid-based strategy maps.',
  ],
];
?>
<!DOCTYPE html>
...
<head>
  ...
  <title>RPG-Strategy — Smart Game Seeker</title>
...
<body>
  ...
  <section class="feat">
    <div class="feat__head">
      <div>
        <h1 class="feat__title">RPG <span class="lime">STRATEGY</span></h1>
        <p class="feat__sub">ストラテジーRPG</p>
      </div>
    </div>
  ...
  <section class="list">
    ...
    <?php if (count($result) === 0) : ?>
      <div class="empty">
        ...
        <h4>Belum ada data RPG-Strategy</h4>
        <p>
          Dataset <code>RPG</code> pada Fuseki belum berisi triple bertipe
          <code>games:RPG-strategy</code>, atau server di
  ...
  <!-- ===================== FOOTER ===================== -->
  <footer class="foot">
    <span class="jp">ストラテジーRPG &middot; SEEKER</span>
        ...
        <div class="modal-body">
          <div class="row">
            ...
            <div class="col-12 col-sm-6 col-md-4 genre-col">
              ...
              <a href="./rpg_strategy.php" class="is-current">RPG-Strategy</a>
            </div>
            <div class="col-12 col-sm-6 col-md-4 genre-col">
              <h2>Simulation</h2>
