...
$sparql_jena_Action = new \EasyRdf\Sparql\Client('http://localhost:3030/Action/sparql');

// ------------------------------------------------------------------
// Query ke dataset "Action" di Fuseki (logika asli, tidak diubah)
// ------------------------------------------------------------------
$save1 = 'SELECT DISTINCT * WHERE {
    ?game rdf:type games:action-adventure;
    games:abstract ?desc;
...
$result = $sparql_jena_Action->query($save1);

// Slide unggulan pada carousel
$featured = [
  [
    'bg'    => 'https://media.tenor.com/dKCKNaAi1OcAAAAd/eldentring.gif',
    'cover' => 'https://i.ytimg.com/vi/E3Huy2cdih0/maxresdefault.jpg',
    'uri'   => 'https://dbpedia.org/page/Elden_Ring',
    'nama'  => 'Elden Ring',
    'dev'   => 'FromSoftware',
    'year'  => '2022',
    'desc'  => 'Elden Ring is a 2022 action role-playing game developed by FromSoftware and published by Bandai Namco Entertainment. It was directed by Hidetaka Miyazaki with worldbuilding provided by fantasy writer George R. R. Martin. Players control a customizable character on a journey to repair the titular Elden Ring and become the new Elden Lord, roaming a vast interactive open world on foot and horseback.',
  ],
  [
    'bg'    => 'https://windowscustomization.com/wp-content/uploads/2019/04/Sekiro-3.gif',
    'cover' => 'https://upload.wikimedia.org/wikipedia/en/6/6e/Sekiro_art.jpg',
    'uri'   => 'https://dbpedia.org/page/Sekiro:_Shadows_Die_Twice',
    'nama'  => 'Sekiro: Shadows Die Twice',
    'dev'   => 'FromSoftware',
    'year'  => '2019',
    'desc'  => 'Sekiro: Shadows Die Twice is a 2019 action-adventure game developed by FromSoftware and published by Activision. The game follows a shinobi known as Wolf, who attempts to take revenge on a samurai clan that attacked him and kidnapped his lord. Gameplay focuses on stealth, exploration, and combat, set in a fictionalised Japan during the Sengoku period.',
  ],
  [
    'bg'    => 'https://steamuserimages-a.akamaihd.net/ugc/138879070085885222/179DD8F03DF544A66834627ADF10A31F9CC9FAB3/?imw=1024&imh=576&ima=fit&impolicy=Letterbox&imcolor=%23000000&letterbox=true',
    'cover' => 'https://upload.wikimedia.org/wikipedia/en/f/fd/Nioh_cover_art.jpg',
    'uri'   => 'https://dbpedia.org/page/Nioh',
    'nama'  => 'Nioh',
    'dev'   => 'Team Ninja',
    'year'  => '2017',
    'desc'  => 'Nioh is an action role-playing video game developed by Team Ninja, released for PlayStation 4 in February 2017. Set during a fictionalised version of the year 1600, the plot follows William Adams, a Western sailor who becomes a samurai. Combat revolves around Ki management and sword stances that counter different enemies.',
  ],
];
?>
<!DOCTYPE html>
...
<head>
  ...
  <title>Action-Adventure — Smart Game Seeker</title>
...
<body>
  ...
  <section class="feat">
    <div class="feat__head">
      <div>
        <h1 class="feat__title">ACTION <span class="lime">ADVENTURE</span></h1>
        <p class="feat__sub">アクションアドベンチャー</p>
      </div>
    </div>
  ...
  <section class="list">
    ...
    <?php if (count($result) === 0) : ?>
      <div class="empty">
        ...
        <h4>Belum ada data Action-Adventure</h4>
        <p>
          Dataset <code>Action</code> pada Fuseki belum berisi triple bertipe
          <code>games:action-adventure</code>, atau server di
  ...
  <!-- ===================== FOOTER ===================== -->
  <footer class="foot">
    <span class="jp">アクション &middot; SEEKER</span>
        ...
        <div class="modal-body">
          <div class="row">
            <div class="col-12 col-sm-6 col-md-4 genre-col">
              <h2>Action</h2>
              <a href="./action_adventure.php" class="is-current">Action-Adventure</a>
