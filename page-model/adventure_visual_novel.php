...
$save1 = 'SELECT DISTINCT * WHERE {
    ?game rdf:type games:adventure-visual_novel;
    games:abstract ?desc;
...
$featured = [
  [
    'bg'    => 'https://images-wixmp-ed30a86b8c4ca887773594c2.wixmp.com/f/c2fb3a25-09ea-4f74-8ad0-35c9648a3839/d73aas4-74eccaa7-7b6f-4fb2-89ae-f10ec1721c63.gif',
    'cover'    => 'https://image.api.playstation.com/cdn/EP0177/CUSA05748_00/ou2hQooMHYl6jCBLAKWI5lU0kVoFympP.png',
    'uri'    => 'https://dbpedia.org/page/Hatsune_Miku:_Project_DIVA_X',
    'nama'    => 'Hatsune Miku: Project DIVA X',
    'dev'    => 'Sega, Crypton Future Media',
    'year'    => '2016',
    'desc'    => 'Hatsune Miku: Project DIVA X is a 2016 rhythm game starring the virtual singer Hatsune Miku, released for the PlayStation Vita and PlayStation 4. Players clear rhythm stages to power up idol modules and unlock new songs and stage performances.',
  ],
  [
    'bg'    => 'https://media.tenor.com/2O3lo_9DSTMAAAAd/phoenix-wright-ace-attorney.gif',
    'cover'    => 'https://image.api.playstation.com/cdn/UP0102/CUSA11513_00/8ZKfCLNdbhr1DnMfpHIcUz7LjYKynmgo.png',
    'uri'    => 'https://dbpedia.org/page/Ace_Attorney',
    'nama'    => 'Ace Attorney',
    'dev'    => 'Capcom',
    'year'    => '2001',
    'desc'    => 'Ace Attorney is a visual novel series developed by Capcom, beginning with Phoenix Wright: Ace Attorney in 2001. Players take on the role of a defense attorney, cross-examining witnesses and presenting evidence to overturn seemingly hopeless court cases.',
  ],
  [
    'bg'    => 'https://giffiles.alphacoders.com/789/78978.gif',
    'cover'    => 'https://giffiles.alphacoders.com/789/78978.gif',
    'uri'    => 'https://dbpedia.org/page/Danganronpa_2:_Goodbye_Despair',
    'nama'    => 'Danganronpa 2: Goodbye Despair',
    'dev'    => 'Spike Chunsoft',
    'year'    => '2012',
    'desc'    => 'Danganronpa 2: Goodbye Despair is a 2012 visual novel developed by Spike Chunsoft, the second entry in the Danganronpa franchise. Sixteen students trapped on an island must solve brutal murders through investigation and class-trial debate to survive.',
  ],
];
?>
<!DOCTYPE html>
...
<head>
  ...
  <title>Visual Novel — Smart Game Seeker</title>
...
<body>
  ...
  <section class="feat">
    <div class="feat__head">
      <div>
        <h1 class="feat__title">VISUAL <span class="lime">NOVEL</span></h1>
        <p class="feat__sub">ビジュアルノベル</p>
      </div>
    </div>
  ...
  <section class="list">
    ...
    <?php if (count($result) === 0) : ?>
      <div class="empty">
        ...
        <h4>Belum ada data Visual Novel</h4>
        <p>
          Dataset <code>Adventure</code> pada Fuseki belum berisi triple bertipe
          <code>games:adventure-visual_novel</code>, atau server di
  ...
  <!-- ===================== FOOTER ===================== -->
  <footer class="foot">
    <span class="jp">ビジュアルノベル &middot; SEEKER</span>
        ...
        <div class="modal-body">
          <div class="row">
            ...
            <div class="col-12 col-sm-6 col-md-4 genre-col">
              ...
              <a href="./adventure_visual_novel.php" class="is-current">Visual Novel</a>
            </div>
            <div class="col-12 col-sm-6 col-md-4 genre-col">
              <h2>Role-Playing</h2>
