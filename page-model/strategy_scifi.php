...
$save1 = 'SELECT DISTINCT * WHERE {
    ?game rdf:type games:scifi-strategy;
    games:abstract ?desc;
...
$featured = [
  [
    'bg'    => 'https://media.giphy.com/media/oq7CJCmI4HGG6kp62U/giphy-downsized-large.gif',
    'cover'    => 'https://upload.wikimedia.org/wikipedia/en/f/f2/Halo_wars.png',
    'uri'    => 'https://dbpedia.org/page/Halo_Wars',
    'nama'    => 'Halo Wars',
    'dev'    => 'Ensemble Studios',
    'year'    => '2009',
    'desc'    => 'Halo Wars is a 2009 real-time strategy game developed by Ensemble Studios for the Xbox 360. Set two decades before the original Halo, it follows the crew of the UNSC Spirit of Fire as they battle the Covenant on the mysterious world of Harvest.',
  ],
  [
  ...
  [
    'bg'    => 'https://64.media.tumblr.com/ba5ead944bb6e0431e5c36ce8aa12c43/tumblr_nv2zralqRf1rfco8to1_1280.gif',
    'cover'    => 'https://upload.wikimedia.org/wikipedia/en/4/4b/Homeworld_%28video_game%29_box_art.jpg',
    'uri'    => 'https://dbpedia.org/page/Homeworld',
    'nama'    => 'Homeworld',
    'dev'    => 'Relic Entertainment',
    'year'    => '1999',
    'desc'    => 'Homeworld is a 1999 real-time strategy game developed by Relic Entertainment, notable for its fully three-dimensional space combat. The Kushan exiles of Kharak build a mobile mothership fleet to reclaim their ancestral homeworld after their planet is destroyed.',
  ],
];
?>
<!DOCTYPE html>
...
<head>
  ...
  <title>Strategy-Scifi — Smart Game Seeker</title>
...
<body>
  ...
  <section class="feat">
    <div class="feat__head">
      <div>
        <h1 class="feat__title">SCI-FI <span class="lime">STRATEGY</span></h1>
        <p class="feat__sub">SFストラテジー</p>
      </div>
    </div>
  ...
  <section class="list">
    ...
    <?php if (count($result) === 0) : ?>
      <div class="empty">
        ...
        <h4>Belum ada data Strategy-Scifi</h4>
        <p>
          Dataset <code>Strategy</code> pada Fuseki belum berisi triple bertipe
          <code>games:scifi-strategy</code>, atau server di
  ...
  <!-- ===================== FOOTER ===================== -->
  <footer class="foot">
    <span class="jp">SFストラテジー &middot; SEEKER</span>
        ...
        <div class="modal-body">
          <div class="row">
            ...
            <div class="col-12 col-sm-6 col-md-4 genre-col">
              ...
              <a href="./strategy_scifi.php" class="is-current">Strategy-Scify</a>
