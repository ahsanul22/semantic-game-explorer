...
$save1 = 'SELECT DISTINCT * WHERE {
    ?game rdf:type games:simulation-life;
    games:abstract ?desc;
...
$featured = [
  [
    'bg'    => 'https://64.media.tumblr.com/26f1ab9a005cb493673231134b359aaf/tumblr_oxgu5brruH1vn6z1jo1_r1_640.gif',
    'cover'    => 'https://upload.wikimedia.org/wikipedia/en/0/07/Harvest_Moon_-_Frantic_Farming_Coverart.png',
    'uri'    => 'https://dbpedia.org/page/Harvest_Moon:_Frantic_Farming',
    'nama'    => 'Harvest Moon: Frantic Farming',
    'dev'    => 'Platinum-Egg',
    'year'    => '2009',
    'desc'    => 'Harvest Moon: Frantic Farming is a 2009 farming puzzle game released for the Nintendo DS. Twelve playable characters race against the clock to plant, grow, and harvest crops in fast-paced puzzle stages, with local multiplayer support.',
  ],
  [
    'bg'    => 'https://media.tenor.com/_UaGrFZuuUYAAAAC/tomodachi-life.gif',
    'cover'    => 'https://media.tenor.com/_UaGrFZuuUYAAAAC/tomodachi-life.gif',
    'uri'    => 'https://dbpedia.org/page/Tomodachi_Life',
    'nama'    => 'Tomodachi Life',
    'dev'    => 'Nintendo',
    'year'    => '2014',
    'desc'    => 'Tomodachi Life is a 2014 life simulation game developed and published by Nintendo for the Nintendo 3DS. Players fill an island with customised Mii characters, giving them personalities and homes while watching their quirky daily lives unfold.',
  ],
  [
    'bg'    => 'https://media.tenor.com/PeegDtyzXS0AAAAC/animal-crossing-animal-crossing-new-horizons.gif',
    'cover'    => 'https://m.media-amazon.com/images/I/91YYP1pWpVL._AC_UF1000,1000_QL80_.jpg',
    'uri'    => 'https://dbpedia.org/page/Animal_Crossing',
    'nama'    => 'Animal Crossing',
    'dev'    => 'Nintendo',
    'year'    => '2001',
    'desc'    => 'Animal Crossing is a life simulation series developed and published by Nintendo, debuting in 2001. Players move into a village of anthropomorphic animal neighbors, decorating their home and passing the time fishing, bug-catching, and fossil hunting.',
  ],
];
?>
<!DOCTYPE html>
...
<head>
  ...
  <title>Simulation-Life — Smart Game Seeker</title>
...
<body>
  ...
  <section class="feat">
    <div class="feat__head">
      <div>
        <h1 class="feat__title">LIFE <span class="lime">SIMULATION</span></h1>
        <p class="feat__sub">ライフシミュレーション</p>
      </div>
    </div>
  ...
  <section class="list">
    ...
    <?php if (count($result) === 0) : ?>
      <div class="empty">
        ...
        <h4>Belum ada data Simulation-Life</h4>
        <p>
          Dataset <code>Simulation</code> pada Fuseki belum berisi triple bertipe
          <code>games:simulation-life</code>, atau server di
  ...
  <!-- ===================== FOOTER ===================== -->
  <footer class="foot">
    <span class="jp">ライフシミュレーション &middot; SEEKER</span>
        ...
        <div class="modal-body">
          <div class="row">
            ...
            <div class="col-12 col-sm-6 col-md-4 genre-col">
              ...
              <a href="./simulation_life.php" class="is-current">Simulation-Life</a>
