...
$save1 = 'SELECT DISTINCT * WHERE {
    ?game rdf:type games:adventure-point_and_click;
    games:abstract ?desc;
...
$featured = [
  [
    'bg'    => 'https://64.media.tumblr.com/dd204418daefc238a2473c6da1434606/tumblr_p6ezhqPXcY1qciqqno2_1280.gif',
    'cover'    => 'https://upload.wikimedia.org/wikipedia/en/5/5a/Thimbleweed_Park_cover_art.png',
    'uri'    => 'https://dbpedia.org/page/Thimbleweed_Park',
    'nama'    => 'Thimbleweed Park',
    'dev'    => 'Terrible Toybox',
    'year'    => '2017',
    'desc'    => 'Thimbleweed Park is a 2017 point-and-click adventure by veteran designers Ron Gilbert and Gary Winnick, funded via Kickstarter. Two mismatched federal agents investigate a murder in a decaying town full of dark secrets and old-school adventure-game humor.',
  ],
  [
    'bg'    => 'https://64.media.tumblr.com/d2debf7e785db83a0d86601e38d1c1b7/tumblr_p6vprk20691uinwq7o2_500.gif',
    'cover'    => 'https://upload.wikimedia.org/wikipedia/en/5/53/Tales_of_Monkey_Island_artwork.jpg',
    'uri'    => 'https://dbpedia.org/page/Tales_of_Monkey_Island',
    'nama'    => 'Tales of Monkey Island',
    'dev'    => 'Telltale Games',
    'year'    => '2009',
    'desc'    => 'Tales of Monkey Island is a 2009 graphic adventure developed by Telltale Games under license from LucasArts. The fifth entry in the beloved pirate saga sends Guybrush Threepwood chasing the sorceress LeChuck across the Caribbean once more.',
  ],
  [
    'bg'    => 'https://steamuserimages-a.akamaihd.net/ugc/2035111621721146334/35B074BC54533E4E12CCDDE85D8AEBE1012C8246/',
    'cover'    => 'https://upload.wikimedia.org/wikipedia/en/8/8a/The_Longest_Journey_%28game_box_art%29.jpg',
    'uri'    => 'https://dbpedia.org/page/The_Longest_Journey',
    'nama'    => 'The Longest Journey',
    'dev'    => 'Funcom',
    'year'    => '1999',
    'desc'    => 'The Longest Journey is a 1999 magical realist point-and-click adventure developed by Funcom. April Ryan discovers she can travel between the technological world of Stark and the magical realm of Arcadia, both of which now depend on her to survive.',
  ],
];
?>
<!DOCTYPE html>
...
<head>
  ...
  <title>Point &amp; Click — Smart Game Seeker</title>
...
<body>
  ...
  <section class="feat">
    <div class="feat__head">
      <div>
        <h1 class="feat__title">POINT &amp; <span class="lime">CLICK</span></h1>
        <p class="feat__sub">ポイントアンドクリック</p>
      </div>
    </div>
  ...
  <section class="list">
    ...
    <?php if (count($result) === 0) : ?>
      <div class="empty">
        ...
        <h4>Belum ada data Point &amp; Click</h4>
        <p>
          Dataset <code>Adventure</code> pada Fuseki belum berisi triple bertipe
          <code>games:adventure-point_and_click</code>, atau server di
  ...
  <!-- ===================== FOOTER ===================== -->
  <footer class="foot">
    <span class="jp">ポイントアンドクリック &middot; SEEKER</span>
        ...
        <div class="modal-body">
          <div class="row">
            ...
            <div class="col-12 col-sm-6 col-md-4 genre-col">
              ...
              <a href="./adventure_point_and_click.php" class="is-current">Point &amp; Click</a>
