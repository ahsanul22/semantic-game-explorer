...
$save1 = 'SELECT DISTINCT * WHERE {
    ?game rdf:type games:sport-simulation;
    games:abstract ?desc;
...
$featured = [
  [
    'bg'    => 'https://media.tenor.com/BIrmExG46IgAAAAC/pes2020-pes2020ronaldhino.gif',
    'cover'    => 'https://upload.wikimedia.org/wikipedia/en/2/2b/Pro_Evolution_Soccer_2020.jpg',
    'uri'    => 'https://dbpedia.org/page/EFootball_PES_2020',
    'nama'    => 'eFootball PES 2020',
    'dev'    => 'PES Productions',
    'year'    => '2019',
    'desc'    => 'eFootball PES 2020 is a football simulation developed by PES Productions and published by Konami, the 19th installment of the Pro Evolution Soccer series. It introduced a partnership with Juventus and refined ball-physics for a more realistic passing game.',
  ],
  [
    'bg'    => 'https://media.tenor.com/ZTJulXs4XakAAAAC/smackdown-vs-raw-hbk.gif',
    'cover'    => 'https://upload.wikimedia.org/wikipedia/en/b/b4/SmackDown%21vsRAW2008.jpg',
    'uri'    => 'https://dbpedia.org/page/WWE_SmackDown_vs._Raw_2008',
    'nama'    => 'WWE SmackDown vs. Raw 2008',
    'dev'    => 'Yuke\'s, Amaze Entertainment',
    'year'    => '2007',
    'desc'    => 'WWE SmackDown vs. Raw 2008 is a professional wrestling simulation published by THQ, developed by Yuke\'s with Amaze Entertainment handling the PSP version. It introduced the Greatest Royal Rumble-style 24/7 mode and expanded create-a-superstar tools.',
  ],
  [
    'bg'    => 'https://media.tenor.com/NXDCv0gwNxcAAAAd/madden-nfl25-all25team.gif',
    'cover'    => 'https://upload.wikimedia.org/wikipedia/en/2/25/Madden_NFL_25_Next-Gen.jpeg',
    'uri'    => 'https://dbpedia.org/page/Madden_NFL_25',
    'nama'    => 'Madden NFL 25',
    'dev'    => 'EA Tiburon',
    'year'    => '2013',
    'desc'    => 'Madden NFL 25 is an American football simulation published by EA Sports, marking the 25th anniversary of the Madden franchise. It introduced the Infinity Engine physics system for more realistic tackling and player collisions.',
  ],
];
?>
<!DOCTYPE html>
...
<head>
  ...
  <title>Sport-Simulation — Smart Game Seeker</title>
...
<body>
  ...
  <section class="feat">
    <div class="feat__head">
      <div>
        <h1 class="feat__title">SPORT <span class="lime">SIMULATION</span></h1>
        <p class="feat__sub">スポーツシミュレーション</p>
      </div>
    </div>
  ...
  <section class="list">
    ...
    <?php if (count($result) === 0) : ?>
      <div class="empty">
        ...
        <h4>Belum ada data Sport-Simulation</h4>
        <p>
          Dataset <code>Sport</code> pada Fuseki belum berisi triple bertipe
          <code>games:sport-simulation</code>, atau server di
  ...
  <!-- ===================== FOOTER ===================== -->
  <footer class="foot">
    <span class="jp">スポーツシミュレーション &middot; SEEKER</span>
        ...
        <div class="modal-body">
          <div class="row">
            ...
            <div class="col-12 col-sm-6 col-md-4 genre-col">
              ...
              <a href="./sport_simulation.php" class="is-current">Sport-Simulation</a>
            </div>
            <div class="col-12 col-sm-6 col-md-4 genre-col">
              <h2>Strategy</h2>
