...
$save1 = 'SELECT DISTINCT * WHERE {
    ?game rdf:type games:RPG-action;
    games:abstract ?desc;
...
$featured = [
  [
    'bg'    => 'https://i.pinimg.com/originals/39/e6/4f/39e64f274e4a687de862688a8babaa99.gif',
    'cover'    => 'https://upload.wikimedia.org/wikipedia/en/0/0c/Witcher_3_cover_art.jpg',
    'uri'    => 'https://dbpedia.org/page/The_Witcher_3:_Wild_Hunt',
    'nama'    => 'The Witcher 3: Wild Hunt',
    'dev'    => 'CD Projekt Red',
    'year'    => '2015',
    'desc'    => 'The Witcher 3: Wild Hunt is a 2015 action role-playing game developed by CD Projekt Red, the third entry in The Witcher series. Monster hunter Geralt of Rivia searches a vast open world for his adopted daughter, pursued by the otherworldly Wild Hunt.',
  ],
  [
    'bg'    => 'https://i.gifer.com/6xJ2.gif',
    'cover'    => 'https://upload.wikimedia.org/wikipedia/en/2/27/Ni_no_Kuni_II_Revenant_Kingdom_cover_art.jpg',
    'uri'    => 'https://dbpedia.org/page/Ni_no_Kuni_II:_Revenant_Kingdom',
    'nama'    => 'Ni no Kuni II: Revenant Kingdom',
    'dev'    => 'Level-5',
    'year'    => '2018',
    'desc'    => 'Ni no Kuni II: Revenant Kingdom is a 2018 action role-playing game developed by Level-5 and published by Bandai Namco. Young king Evan Pettiwhisker Tildrum sets out to build a new kingdom and unite a fractured world against a rising threat.',
  ],
  [
    'bg'    => 'https://i.pinimg.com/originals/62/fd/5f/62fd5f02899d4c481f8977342454b9c1.gif',
    'cover'    => 'https://upload.wikimedia.org/wikipedia/en/c/ce/Dragon_Age_Inquisition_BoxArt.jpg',
    'uri'    => 'https://dbpedia.org/page/Dragon_Age:_Inquisition',
    'nama'    => 'Dragon Age: Inquisition',
    'dev'    => 'BioWare',
    'year'    => '2014',
    'desc'    => 'Dragon Age: Inquisition is a 2014 action role-playing game developed by BioWare, the third main entry in the Dragon Age series. As the Inquisitor, players close rifts tearing the sky apart while navigating the political turmoil of a continent at war.',
  ],
];
?>
<!DOCTYPE html>
...
<head>
  ...
  <title>RPG-Action — Smart Game Seeker</title>
...
<body>
  ...
  <section class="feat">
    <div class="feat__head">
      <div>
        <h1 class="feat__title">RPG <span class="lime">ACTION</span></h1>
        <p class="feat__sub">アクションRPG</p>
      </div>
    </div>
  ...
  <section class="list">
    ...
    <?php if (count($result) === 0) : ?>
      <div class="empty">
        ...
        <h4>Belum ada data RPG-Action</h4>
        <p>
          Dataset <code>RPG</code> pada Fuseki belum berisi triple bertipe
          <code>games:RPG-action</code>, atau server di
  ...
  <!-- ===================== FOOTER ===================== -->
  <footer class="foot">
    <span class="jp">アクションRPG &middot; SEEKER</span>
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <div class="row">
            ...
            <div class="col-12 col-sm-6 col-md-4 genre-col">
              <h2>Role-Playing</h2>
              <a href="./rpg_action.php" class="is-current">RPG-Action</a>
