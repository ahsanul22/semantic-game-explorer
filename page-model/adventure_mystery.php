...
$sparql_jena_Adventure = new \EasyRdf\Sparql\Client('http://localhost:3030/Adventure/sparql');

// ------------------------------------------------------------------
// Query ke dataset "Adventure" di Fuseki (logika asli, tidak diubah)
// ------------------------------------------------------------------
$save1 = 'SELECT DISTINCT * WHERE {
    ?game rdf:type games:adventure-mystery;
    games:abstract ?desc;
...
$result = $sparql_jena_Adventure->query($save1);

// Slide unggulan pada carousel
$featured = [
  [
    'bg'    => 'https://64.media.tumblr.com/ec33c248ddcc057cea062b677eec2c4b/534d8387d6ba4c43-91/s400x600/3c788b2436c15e996337901d3ac3b68bb734f08f.gif',
    'cover'    => 'https://detectivegrimoire.com/img/dg.jpg',
    'uri'    => 'https://dbpedia.org/page/Detective_Grimoire:_Secret_of_the_Swamp',
    'nama'    => 'Detective Grimoire: Secret of the Swamp',
    'dev'    => 'SFB Games',
    'year'    => '2014',
    'desc'    => 'Detective Grimoire: Secret of the Swamp is a murder mystery point-and-click adventure developed by SFB Games. Players take the role of Detective Grimoire as he investigates a killing in a remote swampland, questioning suspects and piecing together clues.',
  ],
  [
    'bg'    => 'https://media.tenor.com/xVhcbWwq4hYAAAAC/detective-conan-conan-edogawa.gif',
    'cover'    => 'https://m.media-amazon.com/images/I/91pPEbR0R-L._AC_UF1000,1000_QL80_.jpg',
    'uri'    => 'https://dbpedia.org/page/Case_Closed:_The_Mirapolis_Investigation',
    'nama'    => 'Case Closed: The Mirapolis Investigation',
    'dev'    => 'Imageepoch',
    'year'    => '2007',
    'desc'    => 'Case Closed: The Mirapolis Investigation is a Wii mystery-adventure game based on the popular Detective Conan anime and manga series. Players follow the teenage detective Conan Edogawa as he unravels a case at a mysterious world exposition.',
  ],
  [
    'bg'    => 'https://38.media.tumblr.com/4d81c970478f84c88044ef0d7303c57a/tumblr_n8elqbRoki1qd4q8ao1_500.gif',
    'cover'    => 'https://38.media.tumblr.com/4d81c970478f84c88044ef0d7303c57a/tumblr_n8elqbRoki1qd4q8ao1_500.gif',
    'uri'    => 'https://dbpedia.org/page/Scooby-Doo_Mystery',
    'nama'    => 'Scooby-Doo Mystery',
    'dev'    => 'Argonaut Games, Illusions Gaming Company',
    'year'    => '1995',
    'desc'    => 'Scooby-Doo Mystery is a 1995 adventure game based on the classic animated series, released for the Sega Genesis and Super Nintendo. Players guide Scooby-Doo and the Mystery Inc. gang through haunted mansions to unmask disguised villains.',
  ],
];
?>
<!DOCTYPE html>
...
<head>
  ...
  <title>Adventure-Mystery — Smart Game Seeker</title>
...
<body>
  ...
  <section class="feat">
    <div class="feat__head">
      <div>
        <h1 class="feat__title">ADVENTURE <span class="lime">MYSTERY</span></h1>
        <p class="feat__sub">アドベンチャーミステリー</p>
      </div>
    </div>
  ...
  <section class="list">
    ...
    <?php if (count($result) === 0) : ?>
      <div class="empty">
        ...
        <h4>Belum ada data Adventure-Mystery</h4>
        <p>
          Dataset <code>Adventure</code> pada Fuseki belum berisi triple bertipe
          <code>games:adventure-mystery</code>, atau server di
  ...
  <!-- ===================== FOOTER ===================== -->
  <footer class="foot">
    <span class="jp">アドベンチャーミステリー &middot; SEEKER</span>
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <div class="row">
            ...
            <div class="col-12 col-sm-6 col-md-4 genre-col">
              <h2>Adventure</h2>
              <a href="./adventure_mystery.php" class="is-current">Adventure-Mystery</a>
