...
$save1 = 'SELECT DISTINCT * WHERE {
    ?game rdf:type games:sport-extreme;
    games:abstract ?desc;
...
$featured = [
  [
    'bg'    => 'https://www.kotaku.com.au/wp-content/uploads/2021/06/15/66e77db0448be53c848e06a7e63542cd.gif',
    'cover'    => 'https://upload.wikimedia.org/wikipedia/en/9/9a/Amped_3_cover.jpg',
    'uri'    => 'https://dbpedia.org/page/Amped_3',
    'nama'    => 'Amped 3',
    'dev'    => 'Indie Built',
    'year'    => '2005',
    'desc'    => 'Amped 3 is a 2005 snowboarding game developed by Indie Built, the third and final entry in the Amped series, exclusive to the Xbox 360. It expanded on its predecessors with a more irreverent tone and an expanded mountain full of freestyle challenges.',
  ],
  [
    'bg'    => 'https://i.makeagif.com/media/4-18-2014/9p0aJQ.gif',
    'cover'    => 'https://upload.wikimedia.org/wikipedia/en/8/84/Skate-3-Boxart.jpg',
    'uri'    => 'https://dbpedia.org/page/Skate_3',
    'nama'    => 'Skate 3',
    'dev'    => 'EA Black Box',
    'year'    => '2010',
    'desc'    => 'Skate 3 is a 2010 skateboarding game developed by EA Black Box, the third entry in the Skate series. Set in the fictional city of Port Carverton, players build a skate empire while pulling off tricks with the series\' signature analog-stick controls.',
  ],
  [
    'bg'    => 'https://media.tenor.com/13PaBqtTAoIAAAAC/heel-flip-shaun-white.gif',
    'cover'    => 'https://upload.wikimedia.org/wikipedia/en/7/76/SWSkateboarding.jpg',
    'uri'    => 'https://dbpedia.org/page/Shaun_White_Skateboarding',
    'nama'    => 'Shaun White Skateboarding',
    'dev'    => 'Ubisoft Montreal',
    'year'    => '2010',
    'desc'    => 'Shaun White Skateboarding is a 2010 sports game developed by Ubisoft Montreal, a spin-off of the Shaun White Snowboarding duology. Players skate through a stylised world that transforms from grey oppression into vivid color as they progress.',
  ],
];
?>
<!DOCTYPE html>
...
<head>
  ...
  <title>Sport-Extreme — Smart Game Seeker</title>
...
<body>
  ...
  <section class="feat">
    <div class="feat__head">
      <div>
        <h1 class="feat__title">EXTREME <span class="lime">SPORTS</span></h1>
        <p class="feat__sub">エクストリームスポーツ</p>
      </div>
    </div>
  ...
  <section class="list">
    ...
    <?php if (count($result) === 0) : ?>
      <div class="empty">
        ...
        <h4>Belum ada data Sport-Extreme</h4>
        <p>
          Dataset <code>Sport</code> pada Fuseki belum berisi triple bertipe
          <code>games:sport-extreme</code>, atau server di
  ...
  <!-- ===================== FOOTER ===================== -->
  <footer class="foot">
    <span class="jp">エクストリームスポーツ &middot; SEEKER</span>
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <div class="row">
            ...
            <div class="col-12 col-sm-6 col-md-4 genre-col">
              <h2>Sport</h2>
              <a href="./sport_extreme.php" class="is-current">Sport-Extreme</a>
