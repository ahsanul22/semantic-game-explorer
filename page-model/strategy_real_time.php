...
$sparql_jena_Strategy = new \EasyRdf\Sparql\Client('http://localhost:3030/Strategy/sparql');

// ------------------------------------------------------------------
// Query ke dataset "Strategy" di Fuseki (logika asli, tidak diubah)
// ------------------------------------------------------------------
$save1 = 'SELECT DISTINCT * WHERE {
    ?game rdf:type games:real-time-strategy;
    games:abstract ?desc;
...
$result = $sparql_jena_Strategy->query($save1);

// Slide unggulan pada carousel
$featured = [
  [
    'bg'    => 'https://64.media.tumblr.com/1629cdec6c6e28581c076f17792a70c1/31d9d5f6e2a35fb7-d7/s540x810/3462b79b954f94b8a62b8a080689c40e29a48345.gif',
    'cover'    => 'https://upload.wikimedia.org/wikipedia/en/6/66/WarcraftIII.jpg',
    'uri'    => 'https://dbpedia.org/page/Warcraft_III:_Reign_of_Chaos',
    'nama'    => 'Warcraft III: Reign of Chaos',
    'dev'    => 'Blizzard Entertainment',
    'year'    => '2002',
    'desc'    => 'Warcraft III: Reign of Chaos is a 2002 real-time strategy game by Blizzard Entertainment, the third entry in the Warcraft universe. It introduced hero units and RPG-style leveling, laying the groundwork for the MOBA genre through its custom map scene.',
  ],
  [
    'bg'    => 'https://i.makeagif.com/media/11-28-2016/onWwXY.gif',
    'cover'    => 'https://upload.wikimedia.org/wikipedia/en/2/20/StarCraft_II_-_Box_Art.jpg',
    'uri'    => 'https://dbpedia.org/page/StarCraft_II:_Wings_of_Liberty',
    'nama'    => 'StarCraft II: Wings of Liberty',
    'dev'    => 'Blizzard Entertainment',
    'year'    => '2010',
    'desc'    => 'StarCraft II: Wings of Liberty is a 2010 sci-fi real-time strategy game developed by Blizzard Entertainment. Jim Raynor leads a rebel fleet against a tyrannical regime, in a campaign renowned alongside the game\'s legendary competitive multiplayer scene.',
  ],
  [
    'bg'    => 'https://steamuserimages-a.akamaihd.net/ugc/798739068481874435/259ED10D48AF71D8C1AEDCEBE86676E5A232DBD2/',
    'cover'    => 'https://upload.wikimedia.org/wikipedia/en/3/32/Total_War_Three_Kingdoms_cover_art.jpg',
    'uri'    => 'https://dbpedia.org/page/Total_War:_Three_Kingdoms',
    'nama'    => 'Total War: Three Kingdoms',
    'dev'    => 'Creative Assembly',
    'year'    => '2019',
    'desc'    => 'Total War: Three Kingdoms is a 2019 strategy game developed by Creative Assembly, set in 190 AD China. It blends turn-based campaign management with real-time battles, letting warlords forge alliances or wage war to reunify a fractured empire.',
  ],
];
?>
<!DOCTYPE html>
...
<head>
  ...
  <title>Strategy-Real Time — Smart Game Seeker</title>
...
<body>
  ...
  <section class="feat">
    <div class="feat__head">
      <div>
        <h1 class="feat__title">REAL-TIME <span class="lime">STRATEGY</span></h1>
        <p class="feat__sub">リアルタイムストラテジー</p>
      </div>
    </div>
  ...
  <section class="list">
    ...
    <?php if (count($result) === 0) : ?>
      <div class="empty">
        ...
        <h4>Belum ada data Strategy-Real Time</h4>
        <p>
          Dataset <code>Strategy</code> pada Fuseki belum berisi triple bertipe
          <code>games:real-time-strategy</code>, atau server di
  ...
  <!-- ===================== FOOTER ===================== -->
  <footer class="foot">
    <span class="jp">リアルタイムストラテジー &middot; SEEKER</span>
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <div class="row">
            ...
            <div class="col-12 col-sm-6 col-md-4 genre-col">
              <h2>Strategy</h2>
              <a href="./strategy_real_time.php" class="is-current">Strategy-Real Time</a>
