...
// Satu-satunya beda dengan action_adventure.php: tipe rdf yang
// dicocokkan (games:action-fantasy, bukan games:action-adventure) —
// dataset Fuseki-nya sendiri sama, "Action", dipakai bersama oleh
// semua sub-genre action.
// ------------------------------------------------------------------
$save1 = 'SELECT DISTINCT * WHERE {
    ?game rdf:type games:action-fantasy;
    games:abstract ?desc;
...
$featured = [
  [
    'bg'    => 'https://i.pinimg.com/originals/63/81/81/638181b7ee564ea078cb89c8a8d31778.gif',
    'cover' => 'https://image.api.playstation.com/vulcan/img/rnd/202010/2614/NVmnBXze9ElHzU6SmykrJLIV.png',
    'uri'   => 'https://dbpedia.org/page/Bloodborne',
    'nama'  => 'Bloodborne',
    'dev'   => 'FromSoftware',
    'year'  => '2015',
    'desc'  => 'Bloodborne is a 2015 action role-playing game developed by FromSoftware and published by Sony Computer Entertainment for the PlayStation 4. Players explore the Gothic city of Yharnam as a Hunter, battling horrific beasts while unraveling the secrets of a blood-borne plague.',
  ],
  [
    'bg'    => 'https://i.pinimg.com/originals/35/e0/c2/35e0c2159b9951f1af4807bea503909c.gif',
    'cover' => 'https://www.gamespot.com/a/uploads/scale_medium/mig/2/0/7/7/2212077-box_sotc.png',
    'uri'   => 'https://dbpedia.org/page/Shadow_of_the_Colossus',
    'nama'  => 'Shadow of the Colossus',
    'dev'   => 'Japan Studio, Team Ico',
    'year'  => '2005',
    'desc'  => 'Shadow of the Colossus is a 2005 action-adventure game developed by Team Ico and published by Sony Computer Entertainment for the PlayStation 2. Wander journeys through a forbidden land to defeat sixteen towering colossi in hopes of reviving a girl named Mono.',
  ],
  [
    'bg'    => 'https://i.pinimg.com/originals/3f/26/ac/3f26acb731d8e3e7095967ab6a66f570.gif',
    'cover' => 'https://assets-prd.ignimgs.com/2021/12/08/nierautomata-1638924135289.jpg',
    'uri'   => 'https://dbpedia.org/page/Nier:_Automata',
    'nama'  => 'Nier: Automata',
    'dev'   => 'PlatinumGames',
    'year'  => '2017',
    'desc'  => 'Nier: Automata is a 2017 action role-playing game developed by PlatinumGames and published by Square Enix. Set during a proxy war between machines and androids, the story follows combat android 2B and scanner android 9S across multiple interwoven playthroughs.',
  ],
];
?>
<!DOCTYPE html>
...
<head>
  ...
  <title>Action-Fantasy — Smart Game Seeker</title>
...
<body>
  ...
  <section class="feat">
    <div class="feat__head">
      <div>
        <h1 class="feat__title">ACTION <span class="lime">FANTASY</span></h1>
        <p class="feat__sub">アクションファンタジー</p>
      </div>
    </div>
  ...
  <section class="list">
    ...
    <?php if (count($result) === 0) : ?>
      <div class="empty">
        ...
        <h4>Belum ada data Action-Fantasy</h4>
        <p>
          Dataset <code>Action</code> pada Fuseki belum berisi triple bertipe
          <code>games:action-fantasy</code>, atau server di
  ...
  <!-- ===================== FOOTER ===================== -->
  <footer class="foot">
    <span class="jp">アクションファンタジー &middot; SEEKER</span>
        ...
        <div class="modal-body">
          <div class="row">
            <div class="col-12 col-sm-6 col-md-4 genre-col">
              ...
              <a href="./action_fantasy.php" class="is-current">Action-Fantasy</a>
