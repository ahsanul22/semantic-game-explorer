...
$save1 = 'SELECT DISTINCT * WHERE {
    ?game rdf:type games:action-horror;
    games:abstract ?desc;
...
$featured = [
  [
    'bg'    => 'https://media.tenor.com/xC762slNwikAAAAd/silent-hill2.gif',
    'cover'    => 'https://images.igdb.com/igdb/image/upload/t_cover_big_2x/co2vyg.jpg',
    'uri'    => 'https://dbpedia.org/page/Silent_Hill_2',
    'nama'    => 'Silent Hill 2',
    'dev'    => 'Team Silent',
    'year'    => '2001',
    'desc'    => 'Silent Hill 2 is a 2001 survival horror game developed by Team Silent and published by Konami for the PlayStation 2. The story follows James Sunderland as he searches the fog-shrouded town of Silent Hill for his deceased wife, confronting monstrous manifestations of his own guilt.',
  ],
  [
    'bg'    => 'https://img.wattpad.',
    'cover'    => 'https://upload.wikimedia.org/wikipedia/en/f/f0/Until_Dawn_cover_art.jpg',
    'uri'    => 'https://dbpedia.org/page/Until_Dawn',
    'nama'    => 'Until Dawn',
    'dev'    => 'Supermassive Games',
    'year'    => '2015',
    'desc'    => 'Until Dawn is a 2015 interactive drama horror game developed by Supermassive Games for the PlayStation 4. Players guide eight young adults stranded on Blackwood Mountain, where every choice made through its butterfly-effect system decides who survives the night.',
  ],
  [
    'bg'    => 'https://i.pinimg.com/originals/7a/12/d2/7a12d2e503c3971a3123bffd4dadbb76.gif',
    'cover'    => 'https://upload.wikimedia.org/wikipedia/en/b/bf/The_Evil_Within_2_cover_art.jpg',
    'uri'    => 'https://dbpedia.org/page/The_Evil_Within_2',
    'nama'    => 'The Evil Within 2',
    'dev'    => 'Tango Gameworks',
    'year'    => '2017',
    'desc'    => 'The Evil Within 2 is a 2017 survival horror game developed by Tango Gameworks and published by Bethesda Softworks. Detective Sebastian Castellanos re-enters the nightmarish simulation of STEM to rescue his daughter from a town collapsing into madness.',
  ],
];
?>
<!DOCTYPE html>
...
<head>
  ...
  <title>Action-Horror — Smart Game Seeker</title>
...
<body>
  ...
  <section class="feat">
    <div class="feat__head">
      <div>
        <h1 class="feat__title">ACTION <span class="lime">HORROR</span></h1>
        <p class="feat__sub">アクションホラー</p>
      </div>
    </div>
  ...
  <section class="list">
    ...
    <?php if (count($result) === 0) : ?>
      <div class="empty">
        ...
        <h4>Belum ada data Action-Horror</h4>
        <p>
          Dataset <code>Action</code> pada Fuseki belum berisi triple bertipe
          <code>games:action-horror</code>, atau server di
  ...
  <!-- ===================== FOOTER ===================== -->
  <footer class="foot">
    <span class="jp">アクションホラー &middot; SEEKER</span>
        ...
        <div class="modal-body">
          <div class="row">
            <div class="col-12 col-sm-6 col-md-4 genre-col">
              ...
              <a href="./action_horror.php" class="is-current">Action-Horror</a>
            </div>
            <div class="col-12 col-sm-6 col-md-4 genre-col">
              <h2>Adventure</h2>
