...
$save1 = 'SELECT DISTINCT * WHERE {
    ?game rdf:type games:simulation-strategy;
    games:abstract ?desc;
...
$featured = [
  [
    'bg'    => 'https://i.gifer.com/3aUl.gif',
    'cover'    => 'https://upload.wikimedia.org/wikipedia/en/d/d2/SimCity_4_cover.jpg',
    'uri'    => 'https://dbpedia.org/page/SimCity_4',
    'nama'    => 'SimCity 4',
    'dev'    => 'Maxis',
    'year'    => '2003',
    'desc'    => 'SimCity 4 is a 2003 city-building simulation developed by Maxis, the fourth major installment in the SimCity series. Players zone, build, and manage a metropolis while balancing budgets, traffic, pollution, and the demands of virtual citizens.',
  ],
  [
    'bg'    => 'https://media.tenor.com/bH7pGFB-0EsAAAAd/microsoft-flight-simulator-2020.gif',
    'cover'    => 'https://upload.wikimedia.org/wikipedia/en/f/fb/FSX_Cover.jpg',
    'uri'    => 'https://dbpedia.org/page/Microsoft_Flight_Simulator_X',
    'nama'    => 'Microsoft Flight Simulator X',
    'dev'    => 'Microsoft Game Studios',
    'year'    => '2006',
    'desc'    => 'Microsoft Flight Simulator X is a 2006 flight simulation developed by Aces Game Studio, the tenth installment of the long-running series. It offers a detailed recreation of real-world aircraft and global terrain for both casual and hardcore flight enthusiasts.',
  ],
  [
    'bg'    => 'https://www.cosmocover.com/wp-content/uploads/2019/10/2510225daf049bb6cd13.62576706-SLIPGIF.gif',
    'cover'    => 'https://upload.wikimedia.org/wikipedia/en/d/d1/Two_Point_Hospital_-_Cover_Art.jpg',
    'uri'    => 'https://dbpedia.org/page/Two_Point_Hospital',
    'nama'    => 'Two Point Hospital',
    'dev'    => 'Two Point Studios',
    'year'    => '2018',
    'desc'    => 'Two Point Hospital is a 2018 business simulation developed by Two Point Studios, spiritual successor to Theme Hospital. Players design and run hospitals treating absurd fictional illnesses, balancing staff, equipment, and patient happiness.',
  ],
];
?>
<!DOCTYPE html>
...
<head>
  ...
  <title>Strategy-Simulation — Smart Game Seeker</title>
...
<body>
  ...
  <section class="feat">
    <div class="feat__head">
      <div>
        <h1 class="feat__title">STRATEGY <span class="lime">SIMULATION</span></h1>
        <p class="feat__sub">シミュレーションストラテジー</p>
      </div>
    </div>
  ...
  <section class="list">
    ...
    <?php if (count($result) === 0) : ?>
      <div class="empty">
        ...
        <h4>Belum ada data Strategy-Simulation</h4>
        <p>
          Dataset <code>Strategy</code> pada Fuseki belum berisi triple bertipe
          <code>games:simulation-strategy</code>, atau server di
  ...
  <!-- ===================== FOOTER ===================== -->
  <footer class="foot">
    <span class="jp">シミュレーションストラテジー &middot; SEEKER</span>
        ...
        <div class="modal-body">
          <div class="row">
            ...
            <div class="col-12 col-sm-6 col-md-4 genre-col">
              ...
              <a href="./strategy_simulation.php" class="is-current">Strategy-Simulation</a>
            </div>
          </div>
        </div>
      </div>
