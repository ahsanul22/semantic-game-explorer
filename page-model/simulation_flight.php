...
$save1 = 'SELECT DISTINCT * WHERE {
    ?game rdf:type games:simulation-flight;
    games:abstract ?desc;
...
$featured = [
  [
    'bg'    => 'https://i.makeagif.com/media/5-14-2015/mjTgKs.gif',
    'cover'    => 'https://m.media-amazon.com/images/I/818NGq9xe7L._AC_UF894,1000_QL80_.jpg',
    'uri'    => 'https://dbpedia.org/page/War_Thunder',
    'nama'    => 'War Thunder',
    'dev'    => 'Gaijin Entertainment',
    'year'    => '2012',
    'desc'    => 'War Thunder is a vehicular combat game developed and published by Gaijin Entertainment, spanning the interwar period through the early Cold War. Players pilot aircraft, drive tanks, and command warships in large-scale historical combined-arms battles.',
  ],
  [
    'bg'    => 'https://media1.giphy.com/media/kE3oPOiUcCy7IwZOoR/giphy.gif',
    'cover'    => 'https://i.pinimg.com/564x/aa/74/80/aa7480f1ff4c26710831676ff0f95a39.jpg',
    'uri'    => 'https://dbpedia.org/page/Ace_Combat_7:_Skies_Unknown',
    'nama'    => 'Ace Combat 7: Skies Unknown',
    'dev'    => 'Bandai Namco Entertainment',
    'year'    => '2019',
    'desc'    => 'Ace Combat 7: Skies Unknown is a 2019 flight combat game developed and published by Bandai Namco, the latest mainline Ace Combat title. Pilots engage in cinematic aerial dogfights across the fictional Strangereal setting, flying dozens of licensed real-world aircraft.',
  ],
  [
    'bg'    => 'https://media.tenor.com/v4tf6N0o0RMAAAAC/project-wingman-sp34r.gif',
    'cover'    => 'https://image.api.playstation.com/vulcan/ap/rnd/202308/1515/14d2073ad439e052731d86bda3d7e5db2db8f9d4346d331f.png',
    'uri'    => 'https://dbpedia.org/page/Project_Wingman',
    'nama'    => 'Project Wingman',
    'dev'    => 'Sector D2',
    'year'    => '2020',
    'desc'    => 'Project Wingman is a flight combat game developed by independent studio Sector D2 and published by Humble Games. A mercenary pilot is drawn into a civil war between two nations, fighting across varied landscapes in arcade-style aerial dogfights.',
  ],
];
?>
<!DOCTYPE html>
...
<head>
  ...
  <title>Simulation-Flight — Smart Game Seeker</title>
...
<body>
  ...
  <section class="feat">
    <div class="feat__head">
      <div>
        <h1 class="feat__title">FLIGHT <span class="lime">SIMULATION</span></h1>
        <p class="feat__sub">フライトシミュレーション</p>
      </div>
    </div>
  ...
  <section class="list">
    ...
    <?php if (count($result) === 0) : ?>
      <div class="empty">
        ...
        <h4>Belum ada data Simulation-Flight</h4>
        <p>
          Dataset <code>Simulation</code> pada Fuseki belum berisi triple bertipe
          <code>games:simulation-flight</code>, atau server di
  ...
  <!-- ===================== FOOTER ===================== -->
  <footer class="foot">
    <span class="jp">フライトシミュレーション &middot; SEEKER</span>
        ...
        <div class="modal-body">
          <div class="row">
            ...
            <div class="col-12 col-sm-6 col-md-4 genre-col">
              ...
              <a href="./simulation_flight.php" class="is-current">Simulation-Flight</a>
            </div>
            <div class="col-12 col-sm-6 col-md-4 genre-col">
              <h2>Sport</h2>
